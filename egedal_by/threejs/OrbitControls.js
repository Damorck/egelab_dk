...
Q3D.Controls = {
  ...
  keyList: [
    "* Mus",
    "Venstre museknap + flyt : Kredsløb",
    "Midterkanpe + flyt : Zoom",
    "Højre museknap + flyt : Panorér",
    "* Tastatur",
    "Piletaster : Flyt horisontalt",
    "Shift + piletaster : Kredsløb",
    "Ctrl + Piletaster : Rotér",
    "Shift + Ctrl + Pil op / Pil ned : Zoom ind / ud",
    "R : Autorotation On / Off",
    "U : Skift mellem op og ned"
  ],
