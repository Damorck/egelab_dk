L.Control.InfoButton = L.Control.extend({
    options: {
        position: 'topleft',
        title:'<h1>SÅDAN GØR DU</h1>',
        linkTitle:'Info',
        html: '<p> Består dit projekt af 4 lige sider, så vælg <b>rektangel-værktøjet</b>. Tryk og træk herefter kortet for at lave rektangel</p><p>Består dit anlæg derimod af mere end 4 sider og kræver <b>frihåndstegning</b>, vælg da værktøjet under rektanglen.Tryk i kortet for fritegning af objekt<p></p><p>Det tegnede objekt kan roteres og skaleres ved tryk eller træk på knækpunkter og kanter. </p><p>Tryk inde i objektet for at <b>se areal</b></p>',
        show: false
    },
